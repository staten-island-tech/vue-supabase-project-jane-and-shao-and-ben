...
export default {
  ...
  methods: {
    spin() {
      this.slot1 = Math.floor(Math.random() * this.data.length);
      this.slot2 = Math.floor(Math.random() * this.data.length);
      this.slot3 = Math.floor(Math.random() * this.data.length);
    }
  }
}
</script>
